...
function SignUpModal() {
  ...
  const {show, username, password, email, full_name } = useSelector(state => state.account);
          ...
          <form method="POST" onSubmit={preventDefault(signUp, () => ({ username, password, email, full_name }))}>
            <div className="field">
              ...
              <div className="control">
                <input required onChange={field} value={username} name="username" className="input" type="username" placeholder="bala bala" />
              </div>
            </div>
            <div className="field">
            ...
            <div className="field">
              ...
              <div className="control">
                <input required onChange={field} value={email} name="email" className="input" type="email" placeholder="you@example.com" />
              </div>
            </div>
            <div className="field">
